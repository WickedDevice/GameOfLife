...
#define NUM_COLUMNS_PER_FRAME_ROW        (16)
#define NUM_ROWS_PER_FRAME_COL           (16)
...
void loop(){    
  ...
  delay(250);    
  print_current_game_board();   
  sr.loadValues(game_board[CURRENT_GAMEBOARD], 16, SHIFT_FIRST_DIGIT_FIRST, SHIFT_LSBIT_FIRST);  
